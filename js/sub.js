window.addEventListener('DOMContentLoaded', function () {
    ...
    container.addListener((e) => {
        ...
        $('.fix_elem').css('transform', `translateY(-${scrollTop * 0.2}px)`);
        ...
        if(scrollTop >= 1358){
            ...
            $('.brand03').removeClass('on');
        }
        if(scrollTop >= 1878){
            $('.brand04').addClass('on');
        }
        else {
            $('.brand04').removeClass('on');
        }
        if(scrollTop >= 2410){
            $('.brand05').addClass('on');
        }
        else {
            $('.brand05').removeClass('on');
        }

        if(scrollTop >= 3324){
            $('.share_text').addClass('on');
        }
        else {
            $('.share_text').removeClass('on');
        }
    ...
    $(".thism_img").slick({
        ...
        arrows: true, //arrow
        prevArrow: $('#section06 .thism_button01'), //prev
        nextArrow: $('#section06 .thism_button02'), //next
    ...
    $(".ymal_contents").slick({
        dots: false, //navigation
        arrows: true, //arrow
        prevArrow: $('#section13 .ymal_button01'), //prev
        nextArrow: $('#section13 .ymal_button02'), //next
        autoplay:true, // autoplay mode
        autoplaySpeed: 2000, // auto speed
        pauseOnHover:false, // pause on mouse hover
        fade: false, //fade mode only one slider
